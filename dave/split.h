...
struct direct_run_check_input_conv_args
{
	struct NNet *nnet;
	struct Interval *input;
	float *equation;
...
int check_functions(struct NNet *nnet, struct Interval *output, int normalized_output);
...
// for input split
int direct_run_check_input_conv(struct NNet *nnet, struct Interval *input,
                     float *equation, float *equation_err,
                     float *new_equation, float *new_equation_err, int depth);
